...
I have two working theories about it:
1. It indicates that the search engine has decided that your bot is a particular good match for the search results, or that a secondary quality (like author ranking) is being engaged, and as such, the bot has moved up higher in the search results than it would otherwise sit. No boost flag means no post-search shuffling. 
